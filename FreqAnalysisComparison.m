...
filename = 'C:\Users\Owner\OneDrive\Research\edp\2dhom\LaminatedFreqAnalysisResults.txt';
...
filename = 'C:\Users\Owner\OneDrive\Research\edp\2dhom\SecondOrderHomogenizedFreqAnalysisResults.txt';
formatSpec = '%13f%14f%f%[^\n\r]';
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', '', 'WhiteSpace', '', 'TextType', 'string',  'ReturnOnError', false);
fclose(fileID);
